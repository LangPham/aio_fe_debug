    ...
    let async_data = create_resource(
        ...
        |(page_current, ref_current, branch_current)| async move {
            let page_query = format!(
                "?page={}&filter[ref_id]={}&filter[branch_code]={}",
                page_current, ref_current, branch_current
            );
                ...
                {move || async_data.read(cx).map(
                    |data| {
                        ...
                        let def_column = [
                            ...
                            DefCol::new("RefId", "log_bravo.data.RefId", "string"),
...
pub fn Filter(
    cx: Scope,
    setter_branch: WriteSignal<String>,
    setter_ref: WriteSignal<String>,
    branch_current: ReadSignal<String>,
    ref_current: ReadSignal<String>,
) -> impl IntoView {
